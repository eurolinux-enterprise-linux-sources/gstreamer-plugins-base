...
Patch0:		jpeg-color-matrix.patch
...
%changelog
* Wed Sep 19 2012 Benjamin Otte <otte@redhat.com> 0.10.29-2
- Add color-matrix support to ffmpegcolorspace
Resolves: rhbz#755777

* Thu Jun 17 2010 Benjamin Otte <otte@redhat.com> 0.10.29-1
- Update to 0.10.29
- Sync with Fedora
Resolves: rhbz#603105

* Sun Jun 06 2010 Benjamin Otte <otte@redhat.com> 0.10.26-3
- Get rid of tabs - use spaces instead.
Resolves: rhbz#600981
 
* Fri Apr 30 2010 Benjamin Otte <otte@redhat.com> 0.10.26-2
- Make a noarch devel-docs subpackage to avoid conflicts
Resolves: rhbz#587261
 
* Fri Feb 12 2010 Bastien Nocera <bnocera@redhat.com> 0.10.26-1
- Update to 0.10.26
Related: rhbz#564325

* Wed Jan 13 2010 Adam Jackson <ajax@redhat.com> 0.10.25.1-2.1
- rtsp-include-fix.patch: Don't declare h_errno, that's netdb.h's job.
- Sync with F-12 updates

* Mon Nov 30 2009 Bastien Nocera <bnocera@redhat.com> 0.10.25.1-2
- Fix theoradec bug with timestamps for Empathy video calls (#537170)
- Fix text subtitle display regression (#537559)
...
- Queue2 element moved to gstreamer core
